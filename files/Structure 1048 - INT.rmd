...
Below is the code responsible for generating the correlation matrix of Structure-ID: 1048.
...
nu_TEST_1048 <- TEST_1048 %>%   select(-c(`Adcy9-83`, `Col6a1-290`, `Dbh-326`, `Erdr1-378`, `Enc1-390`, `Hars-554`, `L1cam-620`, `Pcsk1n-777`, `Prkcz-841`, `Sst-1001`, `Ywhag-1124`, `Pex14-1397`, `Snhg7-1968`, `Ankrd33-2006`, `Adrm1-2019`, `Crat-2119`, `Fbln1-2205`, `Ndufs1-2421`, `Nfkbie-2425`, `Traf7-2527`, `Mapk3-32576`, `Pim2-32583`, `Limk2-61002`, `Bcap29-104826`))
```
...
Below is my attempt at screening through the produced correlation matrix (nu_correlation_1048) and returning specific gene pairs whose correlation coefficient values are equal to or greater than 90%.
...
Below is my attempt at screening through the produced correlation matrix (nu_correlation_1048) and returning specific gene pairs whose correlation coefficient values are equal to or greater than 80%.
...
Below is my attempt at screening through the produced correlation matrix (nu_correlation_1048) and returning specific gene pairs whose correlation coefficient values are equal to or greater than 70%.
